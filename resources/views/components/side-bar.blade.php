<aside class="flex shrink-0 flex-col h-full bg-gray-800 w-80 text-white overflow-auto">
    ...
    <div data-sidebar-dropdown data-sidebar-item class="flex flex-col px-4 mt-2 capitalize gap-2 cursor-pointer opacity-0 transition-opacity duration-300">
        ...
        <div data-sidebar-dropdown-items class="flex flex-col opacity-30 ml-10 mr-5 gap-2 border-l border-gray-500 max-h-0 overflow-hidden transition-all duration-200">
            {{-- <a href="{{ route('06.01.index') }}" class="{{ $pageName == '06.01 Daftar Audit Internal' ? 'sidebar-item-active' : '' }} pl-2 text-sm text-white/70 hover:underline hover:text-white/90"><span class="font-bold">06.01</span> Daftar Audit Internal</a> --}}
            <a href="{{ route('06.02.index') }}" class="{{ $pageName == '06.02 Sasaran Manajemen Keamanan Informasi' ? 'sidebar-item-active' : '' }} pl-2 text-sm text-white/70 hover:underline hover:text-white/90"><span class="font-bold">06.02</span> Sasaran Manajemen Keamanan Informasi</a>
        </div>
    </div>
