...
@section('content')
    <script type="module">
        $(() => {
            ...
            <a href="{{ route('03.05.create') }}" class="flex items-center h-9 px-4 rounded bg-blue-500 hover:bg-blue-600 border border-blue-700 text-white font-semibold cursor-pointer">
                        ...
                        Swal.fire({
                            ...
                            if (result2.isConfirmed) {
                                if (result2.value != 'confirm deletion') {
                                    ...
                                    $.ajax({
                                        type: "delete",
                                        url: "{{ route('03.05.destroy', '') }}/" + $idToDelete,
                                        data: {
                                            _token: "{{ csrf_token() }}",
                                        },
