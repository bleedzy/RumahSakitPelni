...
@endsection
@section('header')
    <h1 style="font-weight: bold; font-size: 2.5em;">05.02 Daftar Pemenuhan Peraturan</h1>
@endsection
@section('content')
<script type="module">
    $(() => {
        ...
        $('.dt-search').closest('.dt-layout-end').append(`
            <a href="{{ route('05.01.create') }}" class="flex items-center h-9 px-4 rounded bg-blue-500 hover:bg-blue-600 border border-blue-700 text-white font-semibold cursor-pointer">
                    ...
                    Swal.fire({
                        ...
                        if (result2.isConfirmed) {
                            if (result2.value != 'confirm deletion') {
                                ...
                                $.ajax({
                                    type: "delete",
                                    url: "{{ route('05.02.destroy', '') }}/" + $idToDelete,
                                    data: {
                                        _token: "{{ csrf_token() }}",
                                    },
    ...
    <div class="px-8 border-gray-500 text-nowrap min-w-min">
        <table id="DataTable" class="row-border">
            ...
            <tr>
                ...
                <th class="text-nowrap">Nama Head Of Legal</th>
                <th>Nama Vice Presiden</th>
                <th>Is Signed</th>
                <th>Signed At</th>
                <th>Document Scan</th>
                <th>Aksi</th>
