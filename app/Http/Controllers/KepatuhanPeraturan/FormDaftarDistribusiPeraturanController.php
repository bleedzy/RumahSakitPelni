...
class FormDaftarDistribusiPeraturanController extends Controller
{
    public function index(Request $request){
        if ($request->ajax()) {
            $query = FormDaftarDistribusiPeraturan::query();
            return DataTables::of($query)
                ->addColumn('action', function ($row) {
                    return '
                        <div class="flex gap-1 ml-1">
                            <a href="' . route('05.03.show', encrypt($row->id)) . '" class="text-blue-700">
        ...
        return view('05.03_daftar_distribusi_peraturan', [
            'pageName' => '05.03 Daftar Distribusi Peraturan'
        ]);
    }
    ...
    public function store(Request $request) {
        ...
        FormDaftarDistribusiPeraturan::create([
        ...
        return redirect()->route('05.03.index')->with('success', 'Peraturan berhasil ditambahkan.');
    }

    public function edit($id) {
        $peraturan = FormDaftarDistribusiPeraturan::findOrFail($id);
        return view('05.03', [
            'pageName' => '',
            'peraturan' => $peraturan
        ]);
    ...
    public function update(Request $request, $id) {
        ...
        return redirect()->route('05.03.index')->with('success', 'Peraturan berhasil diperbarui.');
    }
    ...
    public function destroy($id) {
        ...
        return redirect()->route('05.03.index')->with('success', 'Peraturan berhasil dihapus.');
    }
}
