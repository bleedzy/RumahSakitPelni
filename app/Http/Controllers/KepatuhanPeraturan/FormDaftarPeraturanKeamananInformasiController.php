...
use App\Models\KepatuhanPeraturan\FormDaftarPeraturanKeamananInformasi;
use Illuminate\Http\Request;
use Yajra\DataTables\Facades\DataTables;
use Illuminate\Support\Facades\Storage;

class FormDaftarPeraturanKeamananInformasiController extends Controller
{
    public function index(Request $request) {
        if ($request->ajax()) {
            $query = FormDaftarPeraturanKeamananInformasi::query();
    ...
    public function create() {
        return view('05.01_form_tambah_peraturan_keamanan_informasi', [
            'pageName' => 'Tambah Peraturan Keamanan Informasi'
        ]);
    }
    ...
    public function store(Request $request) {
        ...
        FormDaftarPeraturanKeamananInformasi::create([
        ...
        return redirect()->route('05.01.index')->with('success', 'Peraturan berhasil ditambahkan.');
    }

    public function edit($id) {
        $peraturan = FormDaftarPeraturanKeamananInformasi::findOrFail($id);
        return view('05.01_form_edit_peraturan', [
            'pageName' => 'Edit Peraturan Keamanan Informasi',
            'peraturan' => $peraturan
        ]);
    }
    ...
    public function update(Request $request, $id) {
        ...
        return redirect()->route('05.01.index')->with('success', 'Peraturan berhasil diperbarui.');
    }
    ...
    public function destroy($id) {
        ...
        return redirect()->route('05.01.index')->with('success', 'Peraturan berhasil dihapus.');
    }
}
